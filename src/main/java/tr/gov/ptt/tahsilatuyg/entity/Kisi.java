 ...
 */
package tr.gov.ptt.tahsilatuyg.entity;
...
public class Kisi implements Serializable {
    ...
    @NotNull
    @Column(name = "NO")
    @SequenceGenerator(name = "kisiseq", sequenceName = "SEQ_THS_KISI", allocationSize = 1, initialValue = 1)
    ...
    public String toString() {
        return "tr.gov.ptt.tahsilatuyg.entity.Kisi[ no=" + no + " ]";
    }
